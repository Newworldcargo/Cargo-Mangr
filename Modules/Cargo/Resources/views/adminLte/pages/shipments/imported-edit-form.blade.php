        ...
        <div class="card h-100 border">
            ...
            <div class="card-body row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <select name="Shipment[branch_id]" class="form-select" required>
                ...
                <div class="col-md-6">
                    ...
                    <select name="Shipment[type]" class="form-select" required>
                        <option value="1" @selected((int) $field('type', $model->type) === 1)>Pickup</option>
                        <option value="2" @selected((int) $field('type', $model->type) === 2)>Drop off</option>
                    </select>
                </div>
                <div class="col-12">
                    <label class="form-label required">Customer</label>
                    <select name="Shipment[client_id]" class="form-select" required>
                ...
                <div class="col-md-6">
                    ...
                    <input name="Shipment[client_phone]" value="{{ $field('client_phone', $model->client_phone) }}" class="form-control">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input name="Shipment[reciver_name]" value="{{ $field('reciver_name', $model->reciver_name) }}" class="form-control">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Receiver phone</label>
                    <input name="Shipment[reciver_phone]" value="{{ $field('reciver_phone', $model->reciver_phone) }}" class="form-control">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input name="Shipment[reciver_address]" value="{{ $field('reciver_address', $model->reciver_address) }}" class="form-control">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card h-100 border">
            ...
            <div class="card-body row g-4">
                <div class="col-md-6">
                    ...
                    <select id="import-from-country" name="Shipment[from_country_id]" class="form-select">
                ...
                <div class="col-md-6">
                    ...
                    <select id="import-to-country" name="Shipment[to_country_id]" class="form-select">
                        <option value="">Select country</option>
                ...
                <div class="col-md-6">
                    <label class="form-label">Origin province/state</label>
                    <select id="import-from-state" name="Shipment[from_state_id]" class="form-select" data-current="{{ $field('from_state_id', $model->from_state_id) }}">
                ...
                <div class="col-md-6">
                    <label class="form-label">Destination province/state</label>
                    <select id="import-to-state" name="Shipment[to_state_id]" class="form-select" data-current="{{ $field('to_state_id', $model->to_state_id) }}">
                        <option value="">Select state</option>
                ...
                <div class="col-md-6">
                    ...
                    <select id="import-from-area" name="Shipment[from_area_id]" class="form-select" data-current="{{ $field('from_area_id', $model->from_area_id) }}">
                ...
                <div class="col-md-6">
                    ...
                    <select id="import-to-area" name="Shipment[to_area_id]" class="form-select" data-current="{{ $field('to_area_id', $model->to_area_id) }}">
                        <option value="">Not specified</option>
        ...
        @forelse($model->packageShipments as $index => $parcel)
            ...
            <div class="row g-4 pb-5 mb-5 border-bottom">
                <div class="col-md-3">
                    ...
                    <select name="Package[{{ $index }}][package_id]" class="form-select" required>
                ...
                <div class="col-md-5"><label class="form-label">Goods description</label><input name="Package[{{ $index }}][description]" value="{{ old("Package.$index.description", $parcel->description) }}" class="form-control"></div>
                ...
                <div class="col-md-2"><label class="form-label">Weight (kg)</label><input type="number" min="0" step="0.01" name="Package[{{ $index }}][weight]" value="{{ old("Package.$index.weight", $parcel->weight) }}" class="form-control"></div>
...
<div class="card border mt-6">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <span class="badge {{ $model->paid ? 'badge-success' : 'badge-secondary' }}">{{ $model->paid ? 'PAID' : 'UNPAID' }}</span>
    </div>
    <div class="card-body row g-4">
        <div class="col-md-4"><label class="form-label required">Total weight (kg)</label><input type="number" min="0" step="0.01" name="Shipment[total_weight]" value="{{ $field('total_weight', $model->total_weight) }}" class="form-control" required></div>
        <div class="col-md-4"><label class="form-label">Shipping price</label><input type="number" min="0" step="0.01" name="Shipment[shipping_cost]" value="{{ $field('shipping_cost', $model->shipping_cost) }}" class="form-control"></div>
        <div class="col-md-4"><label class="form-label">Amount to collect</label><input type="number" min="0" step="0.01" name="Shipment[amount_to_be_collected]" value="{{ $field('amount_to_be_collected', $model->amount_to_be_collected) }}" class="form-control"></div>
